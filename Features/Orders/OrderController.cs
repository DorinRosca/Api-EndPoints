using ApiEndPoints.Features.Orders.Command.Cancel;
using ApiEndPoints.Features.Orders.Command.Confirm;
using ApiEndPoints.Features.Orders.Command.Create;
using ApiEndPoints.Features.Orders.Query.GetOrders;
using ApiEndPoints.Features.Orders.Query.GetUserOrders;
...
namespace ApiEndPoints.Features.Orders
{
    [Authorize]
